...
def procesar_todas_las_noticias(archivo_entrada: str, archivo_salida: str):
    ...
    print(f"{len(noticias_resumidas)} noticias resumidas guardadas en '{archivo_salida}'")
from pathlib import Path
base = Path(__file__).resolve().parent
procesar_todas_las_noticias(base / "../noticias/noticias.json", base / "../noticias/noticias_resumen.json")